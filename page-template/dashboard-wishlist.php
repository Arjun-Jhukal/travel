...
/**
 * Template Name: Dashboard Wishlist Template
 * 
 */
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="pi-content">
                          ...
                          <div class="pl-key-indicator d-flex justify-content-between align-items-center">
                            ...
                            <div class=" indicator-item location">
                              <img src="<?php echo get_parent_theme_file_uri() ?>/assets/images/icons/location.svg"
                                alt="">
                            ...
                            <div class="indicator-item ">
                              <img
                                src="<?php echo get_parent_theme_file_uri() ?>/assets/images/icons/filled-star-sm.svg"
                                alt="">
                              <span> <small><?php echo $tour_rating; ?>
                                  &nbsp;</small><small>(<?php echo $tour_ratings; ?>)</small></span>
                            </div>
                            <div class="indicator-item">
                              <img src="<?php echo get_parent_theme_file_uri() ?>/assets/images/icons/calendar-day.svg"
                                alt="">
                      ...
                      <div class="col-xl-3">
                        ...
                        <div class="package-btn-group">
                          ...
                          <a href="#"
                            class="bh-btn bh-btn-outlined red-outline d-block text-center remove-from-wishlist"
                            data-id="<?php echo esc_attr($package_id); ?>">Remove
                            from list</a>
                        </div>
                      </div>
                    </div>
