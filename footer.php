...
<footer class="footer ">
  ...
  <div class="footer-signature d-lg-none">
    <div class="container">
      <div class="fs-content d-md-flex justify-content-between align-item-center text-center">
...
$rcb_desc = $tour_maps_rcb['rcb_desc'];
if ($enable_rcb):
  ?>
  <!-- Quick Inquiry form -->
  <div class="popup-form quick-inquiry ">
    <div class="pf-content">
      <div class="pf-header">
        <h4><?php echo $rcb_title .' - '. get_the_title();?></h4>
        <p><?php echo $rcb_desc; ?></p>
      </div>

      <?php echo do_shortcode('[contact-form-7 id="b717707" title="Quick Inquiry Form"]');?>
