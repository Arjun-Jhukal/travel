    ...
    <div class="testimonials-wrapper">
      <div class="testimonial-tab d-lg-flex justify-content-between align-items-center ">
        ...
        <?php foreach ($reviews as $index => $customer_reviews):
            ...
            ?>
        <div class="platform-info  justify-content-lg-end align-items-center <?php echo $index===0?  "active":"";?>"
          id="bold-item<?php echo $index; ?>">
          <div class="pi-icon">
            <?php
      ...
      <div class="multiple-testimonial-slider">
        <?php foreach ($reviews as $index => $customer_reviews):
            $review_items = $customer_reviews['review_items'];
            ?>
        <div class="platform-testimonial-wrapper <?php echo $index===0?  "active":"";?>">
          <div class="testimonial-slider-wrapper ">
            <div class="testimonial-slider" id="bold-item<?php echo $index; ?>">
              ...
              <div class="testimonial-item">
                ...
                <div class="review-rating" data-rating="<?php echo $ri_rating; ?>">
                ...
                <?php if($reviews_link):?>
                <a href="<?php echo esc_url($reviews_link);?>" class="bh-btn bh-btn-underlined" target="_blank">Read
                  More
