<section class="blogs bg-white">
  <div class="container">
    <div class="row">
      <div class="col-xl-3">
        <div class="section-title d-flex justify-content-between align-items-start d-xl-block">
          <h2>Read the latest
            <span>Blogs & Insights</span>
          </h2>
          <div class="st-brief">
            <p>Explore our collection of articles and insights to gain in-depth travel knowledge, expert advice, and
              stay updated on the latest trends and tips.</p>
            <a href="#" class="bh-btn bh-btn-underlined">View All Articles</a>
          </div>
        ...
        <div class="blog-slider-wrapper">
          <div class="blog-slider" id="blog-slider">
            <div class="blog-item">
              <div class="bi-image">
                <a href="#">
                  <img src="<?php echo get_parent_theme_file_uri()?>/assets/images/placeholder-20.png" alt=""
                    class="img-fluid">
                </a>
              </div>
              <div class="bi-content">
                <small>06 Sept. 2024</small>
                <a href="#">Everything You Need to Know About Kanchenjunga Base Camp Trek</a>
              </div>
            </div>
            <div class="blog-item">
              <div class="bi-image">
                <a href="#">
                  <img src="<?php echo get_parent_theme_file_uri()?>/assets/images/placeholder-22.png" alt=""
                    class="img-fluid">
                </a>
              </div>
              <div class="bi-content">
            ...
            <div class="blog-item">
              <div class="bi-image">
                <a href="#">
                  <img src="<?php echo get_parent_theme_file_uri()?>/assets/images/placeholder-21.png" alt=""
                    class="img-fluid">
                </a>
              </div>
              <div class="bi-content">
